...
if __name__ == '__main__':
    ...
    plt.savefig('fig/SIMPLE_model_vs_mse.png', bbox_inches='tight')

    # Write out results in model_str.txt
    util.write_models_to_txt('models/SIMPLE_model_str.txt', models, query_inds)
    ...
    plt.xlabel('$z$')
    plt.legend()
    plt.savefig('fig/SIMPLE_model_result.png', bbox_inches='tight')
