...
if __name__ == '__main__':
    ...
    plt.savefig('data/fig/TURBULENCE_model_vs_mse.png', bbox_inches='tight')

    # Write out results in model_str.txt
    util.write_models_to_txt('data/models/TURBULENCE_model_str.txt', models, query_inds)

    # Plot uu component
    model_uu = dataproc.eval_model(models['str_'][best_ind_], lib['var_dict_full'])[0, 0, :]
    plot_pcolor_data(data_i, model_uu, '$uu$')
    plt.savefig('data/fig/TURBULENCE_model_result.png', bbox_inches='tight')
